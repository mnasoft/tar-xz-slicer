...
arch=('any')
url="https://github.com/yourusername/tar-xz-slicer"
license=('MIT')
...
sha256sums=('SKIP' 'SKIP')  # для начала можно пропустить; позже можно зафиксировать
...
package() {
  ...
  gzip -c "${srcdir}/man/${pkgname}.1" > "${pkgdir}/usr/share/man/man1/${pkgname}.1.gz"
